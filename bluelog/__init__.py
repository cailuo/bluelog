...
from bluelog.extensions import bootstarp, db, moment, mail, ckeditor, mail, moment, toolbar, migrate, login_manager, csrf
...
def register_logging(app):
    ...
    file_hanler = RotatingFileHandler(os.path.join(basedir, 'logs/bluelog.log'), maxBytes=10 * 1024 * 1024, backupCount=10)
    file_hanler.setFormatter(formatter)
    file_hanler.setLevel(logging.INFO)
    ...
    if not app.debug:
        ...
        app.logger.addHandler(file_hanler)
